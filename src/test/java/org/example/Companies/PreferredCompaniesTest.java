...
public class PreferredCompaniesTest {
    ...
    public void testGetPreferredCompanies() {
        PreferredCompanies preferredCompanies = new PreferredCompanies();

        String nin = config.getTestNin();

        Response response = preferredCompanies.getPreferredCompanies(nin);
