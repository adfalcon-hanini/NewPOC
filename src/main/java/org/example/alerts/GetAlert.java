...
public class GetAlert extends BaseApi {

    private static final String SERVICE_NAME = "MNGALERT";
    private static final String REQ_OP_CODE = "GETDATA";

    public Response getAlert(String nin, String alertSource, String lang,
                             String userId, String userType, String lstLogin) {
        logger.info("Executing GetAlert for NIN: {}", nin);
    ...
    public Response getAlert(String nin, String lstLogin) {
        return getAlert(
                nin,
                "",
    ...
    public Response getAlert(String nin) {
        return getAlert(nin, config.getTestLstLogin());
    }
}
